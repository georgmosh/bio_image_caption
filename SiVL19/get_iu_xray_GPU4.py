...
quarters_train_split = int(3 * numpy.floor(len(reports_with_images) * 0.9)/4)
test_split = len(reports_with_images) - train_split

train_part1 = keys[:quarters_train_split]
train_part2 = keys[quarters_train_split+test_split:]
train_keys = train_part1 + train_part2
test_keys = keys[quarters_train_split:quarters_train_split+test_split]

train_path = "iu_xray/train_images_GPU4.tsv"
test_path = "iu_xray/test_images_GPU4.tsv"

print("train size", train_split/len(reports_with_images))
print("test size", test_split/len(reports_with_images))
