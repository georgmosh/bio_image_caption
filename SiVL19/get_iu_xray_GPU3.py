...
quarter_train_split = int(numpy.floor(len(reports_with_images) * 0.9)/4)
test_split = len(reports_with_images) - train_split

train_part1 = keys[:quarter_train_split]
train_part2 = keys[quarter_train_split+test_split:]
train_keys = train_part1 + train_part2
test_keys = keys[quarter_train_split:quarter_train_split+test_split]

train_path = "iu_xray/train_images_GPU3.tsv"
test_path = "iu_xray/test_images_GPU3.tsv"
